...
const ContentBox = ({ title, content, arrFirstRow, arrSecondRow, infoFirstTab, infoSecondTab }) => {
    ...
    return (
        <div
            ...
            <div className="select-part">
                ...
                <div className="select-title">132</div>
                <div className="select-content">123</div>
